...
import { features } from './DataBase/FeatureData'
...
const FeatureSection = () => {
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
        ...
        <div className='flex flex-wrap mx-auto mt-10 lg:mt-20 w-[80%] justify-center'>
            {
                features.map((features, index) => (
                    <div key={index} className='w-full lg:w-1/3'>
                        <div className='flex'>
                            ...
                            <div>
                                <h5 className='mt-1 text-xl'>{features.text}</h5>
